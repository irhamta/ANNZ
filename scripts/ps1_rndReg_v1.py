...
glob.annz["outDirName"] = "PS1_randReg"
...
glob.annz["zTrg"]       = "specz"
glob.annz["minValZ"]    = 0.0
glob.annz["maxValZ"]    = 8.0
...
if glob.annz["doGenInputTrees"]:
  ...
  glob.annz["inAsciiVars"]  = "F:ra;F:dec;F:ps1Mag_g;F:ps1Mag_r;F:ps1Mag_i;F:ps1Mag_z;F:ps1Mag_y;F:decalsMag_g;F:decalsMag_r;F:decalsMag_z;F:unwiseMag_w1;F:ps1Mag_g_err;F:ps1Mag_r_err;F:ps1Mag_i_err;F:ps1Mag_z_err;F:ps1Mag_y_err;F:decalsMag_g_err;F:decalsMag_r_err;F:decalsMag_z_err;F:unwiseMag_w1_err;F:specz;F:Mag_J;F:Mag_J_err;F:z_y;F:y_J;F:err_z_y;F:err_y_J"
  ...
  if   inFileOpt == 0:
    ...
    glob.annz["splitTypeTrain"]  = "PS1.train"
    glob.annz["splitTypeTest"]   = "PS1.test"

  elif inFileOpt == 1:
    glob.annz["splitType"]       = "random" # "serial", "blocks" or "random"
    glob.annz["inAsciiFiles"]    = "PS1.train;PS1.test"
  ...
  if useWgtKNN:
    ...
    glob.annz["inAsciiFiles_wgtKNN"]   = "PS1.target"
    glob.annz["inAsciiVars_wgtKNN"]    = "F:ra;F:dec;F:ps1Mag_g;F:ps1Mag_r;F:ps1Mag_i;F:ps1Mag_z;F:ps1Mag_y;F:decalsMag_g;F:decalsMag_r;F:decalsMag_z;F:unwiseMag_w1;F:ps1Mag_g_err;F:ps1Mag_r_err;F:ps1Mag_i_err;F:ps1Mag_z_err;F:ps1Mag_y_err;F:decalsMag_g_err;F:decalsMag_r_err;F:decalsMag_z_err;F:unwiseMag_w1_err;F:Mag_J;F:Mag_J_err;F:z_y;F:y_J;F:err_z_y;F:err_y_J"
    ...
    glob.annz["weightInp_wgtKNN"]      = "1/ps1Mag_y"
    glob.annz["weightRef_wgtKNN"]      = "1/ps1Mag_y"

    glob.annz["weightVarNames_wgtKNN"] = "ps1Mag_g;ps1Mag_r;ps1Mag_i;ps1Mag_z;ps1Mag_y;decalsMag_g;decalsMag_r;decalsMag_z;unwiseMag_w1;Mag_J;z_y;y_J"
    ...
    glob.annz["outAsciiVars_wgtKNN"]   = "ra;dec"                        # write out two additional variables to the output file
#    glob.annz["weightRef_wgtKNN"]      = "(ps1Mag_y_err<0.3)*1 + (ps1Mag_y_err>=0.3)/ps1Mag_y_err" # down-weight objects with high MAGERR_R
...
if glob.annz["doTrain"]:
  ...
  for nMLMnow in range(glob.annz["nMLMs"]):
    ...
    # - example use:
    # --------------------------------------------------------------------------------------------------
    if   nMLMnow%3 == 0: glob.annz["inputVariables"] = "ps1Mag_g;ps1Mag_r;ps1Mag_i;ps1Mag_z;ps1Mag_y;decalsMag_g;decalsMag_r;decalsMag_z;unwiseMag_w1;Mag_J;z_y;y_J"
    elif nMLMnow%3 == 1: glob.annz["inputVariables"] = "ps1Mag_g;ps1Mag_r;ps1Mag_i;ps1Mag_z;ps1Mag_y;decalsMag_g;decalsMag_r;decalsMag_z;unwiseMag_w1;Mag_J"
    elif nMLMnow%3 == 2: glob.annz["inputVariables"] = "ps1Mag_i;ps1Mag_z;ps1Mag_y;decalsMag_g;decalsMag_r;decalsMag_z;Mag_J"
    ...
    # - example use:
    # --------------------------------------------------------------------------------------------------
    if nMLMnow == 0: glob.annz["inputVarErrors"] = "ps1Mag_g_err;ps1Mag_r_err;ps1Mag_i_err;ps1Mag_z_err;ps1Mag_y_err;decalsMag_g_err;decalsMag_r_err;decalsMag_z_err;unwiseMag_w1_err;Mag_J_err;err_z_y;err_y_J"
...
#    glob.annz["userCuts_valid"]           = "(MAGERR_R < 1)"
  ...
  # --------------------------------------------------------------------------------------------------
  glob.annz["addOutputVars"] = "ra;dec"
  ...
  # --------------------------------------------------------------------------------------------------
  glob.annz["max_sigma68_PDF"] = 0.05
  ...
  # --------------------------------------------------------------------------------------------------
    ...
    glob.annz["inDirName"]      = "data/"
    glob.annz["inAsciiFiles"]   = "PS1.target"
